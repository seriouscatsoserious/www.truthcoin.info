...
In Part 1, I explain my goal. In Parts 2-4, I explain why we are not achieving it.

In Parts 5-6, I list out some frustrations and anxieties that people have with "the details" of democracy (ie, jerry-mandering, separation-of-powers, red tape, deep state, etc) -- and how best to deal with them all simultaneously.

In Part 7, I sketch out my "ideal democracy" -- in other words: how I would implement democracy, if starting from scratch. I describe the "missing pieces" -- and plug them in.

In Part 8, I give *advice* -- individual actions that would steer the country into a better future.

Part 9 is a huge table -- contrasting my view of Democracy with "the mainstream view".

Part 10 is a conclusion, with 4 Appendices.
