...
The truth is that **the election** *--is--* the environmental review. (It's the everything review.)  The governor[^1] would campaign on "a train connecting LA and SF!". His political opponent, would then raise the issue of "environmental damage" (and "costs", and "inconvenience", ...), and finally the people would vote. They'd vote on the whole "bundle" -- at once.

[^1]: Alternatively, the cities could do it without the governor. Each city along the planned rail route, could join a new organization (like NYC's Port Authority) -- mayors of these cities could voluntarily join or leave (this would be a decision they would have to justify to their voters). This organization could have its own leader, who would then run the LA-SF rail project (without the governor's help).
...
First, notice this is an example of an "independent court" *removing* a progressive right, rather than protecting one! Second, the *overall effect* of their ruling, on actual abortion rights, has been small. Abortion bans were passed in only 14 states (29% [of the US](https://www.politifact.com/factchecks/2024/jan/30/kamala-harris/kamala-harris-is-right-1-in-3-women-of-reproductiv/) population). Of all women affected by these bans, plausibly most[^2] (albeit not all) could travel to a nearby state and get an abortion anyway.

[^2]: A round-trip [greyhound bus ticket](https://shop.greyhound.com), from NYC to LA (booked two weeks in advance), costs about $160. Atlanta to Charlotte is $38. In contrast, raising a child from birth to age 18 is estimated to cost [$200,000 - $300,000]. The [10th-percentile hourly wage](https://www.bls.gov/ecec/factsheets/compensation-percentile-estimates.htm) was $14.06, in March 2024.
...
1. If the President is fired, then the *Vice-President* takes over... but the President and VP are from the same *party*[^4]. So *the party* is never fired. This makes the president vulnerable to his subordinates (undermining his authority -- and accountability), as follows:
