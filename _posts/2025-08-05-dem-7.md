...
* The CAO can select themselves as candidate (unless the ByLaws forbid it).[^n]
...
[^n]: I would hope that voters would *ridicule* such a choice, and vote against it on Election Day.
...
But *informally* it would be quite easy. A critical mass of DNC members could just start *acting* as if (for example) "George Clooney is our CAO"[^n]. They could just start treating him as though he were in charge -- voluntarily deferring to him. Then, Clooney could start firing people, weeding out the disloyal and the underperformers.

[^n]: This might make a good t-shirt!
